...
async function generateFullReport(
  ...
  if (latestResult) {
    ...
    const healthProjection = getHealthProjection(
      latestResult.metrics.aqiImprovement,
      latestResult.metrics.co2Reduction,
      latestResult.metrics.healthBenefit
    );

    paragraph(healthProjection.outlook, 10, [210, 210, 210]);
    gap(2);
    dataRow(

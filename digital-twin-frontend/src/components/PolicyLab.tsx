      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <Reveal>
          <div className="flex flex-col gap-4 mb-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-3 self-start rounded-2xl border border-white/10 bg-white/5 px-3 py-2">
              ...
              <div className="flex items-center gap-1 rounded-full bg-black/20 p-1 border border-white/10">
                {[2026, 2027, 2028].map((year) => {
                  const isActive = timeHorizon[1] === year;
                  return (
                    <button
                      key={year}
                      onClick={() => setTimeHorizon([timeHorizon[0], year])}
